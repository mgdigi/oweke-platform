...
.hero-content h1 span.underline::after {
  ...
  position: absolute;
  left: 0;
  bottom: -5px; /* Adjusts the vertical position of the underline */
  width: 100%;
  height: 2px; /* Adjust thickness of the underline */
  background-color: #b969d4; /* Color of the underline */
...
.hero-content p {
  ...
  border-left: 3px solid #000; /* Changed the line color to black */
...
.community-events h2 {
  font-size: 28px;
  font-weight: bold;
  color: #2E2E2E; /* Darker color */
  margin-bottom: 15px;
  position: relative;
  display: inline-block;
}

.community-events h2 .underline {
  position: relative;
  color: #000; /* Ensure text is black */
}

.community-events h2 .underline::after {
  content: '';
  position: absolute;
  left: 0;
  bottom: -5px; /* Adjusts the vertical position of the underline */
